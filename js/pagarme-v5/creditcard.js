...
const getCardNumber = () => get('#pagarmev5_creditcard_creditcard_number').value;

const getCardExpirationDate = () => get('#pagarmev5_creditcard_creditcard_expiration_date').value;
...
const getCardData = () => {
  return {
    ...
    card_holder_name: get('#pagarmev5_creditcard_creditcard_owner').value,
    card_expiration_date: getCardExpirationDate().replace(/\s|\//g, ''),
    card_cvv: get('#pagarmev5_creditcard_creditcard_cvv').value,
  };
}

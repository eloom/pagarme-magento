...
class PagarMeV5_Core_Model_Quote_Address_Total_CreditCardInterestAmount
	extends PagarMeV5_Core_Model_Quote_Address_Total_Abstract {
	private $interestAmount;

	public function __construct() {
		$this->setCode('pagarmev5_creditcard');
	}
	...
	public function getLabel() {
		return Mage::helper('pagarmev5_core')
	...
	public function shouldCollect() {
		...
		if (!$transaction instanceof \PagarMeV5\Sdk\Transaction\CreditCardTransaction) {
			return false;
		}

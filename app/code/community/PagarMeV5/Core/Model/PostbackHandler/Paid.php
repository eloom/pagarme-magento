...
class PagarMeV5_Core_Model_PostbackHandler_Paid extends PagarMeV5_Core_Model_PostbackHandler_Base {
	/**
	...
	private function getInvoiceService() {
		return Mage::getModel(
			'pagarmev5_core/service_invoice'
		);
	}
	 ...
	 * @throws PagarMeV5_Core_Model_PostbackHandler_Exception
	 */
	public function process() {
		...
		if (!$this->order->canInvoice()) {
			...
			throw new PagarMeV5_Core_Model_PostbackHandler_Exception($message);
		}

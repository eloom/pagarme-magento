...
class PagarMeV5_Creditcard_Model_Quote_Address_Total_CreditCardInterestAmount extends Mage_Sales_Model_Quote_Address_Total_Abstract {
	 ...
	 * @param Mage_Sales_Model_Quote_Address $address
	 *
	 * @return PagarMeV5_Creditcard_Model_Quote_Address_Total_CreditCardInterestAmount
	 */
	...
	private function interestAmountInReals($address, $paymentMethodParameters) {
		$pagarMeSdk = Mage::getModel('pagarmev5_core/sdk_adapter')
			->getSdk();

		$helper = Mage::helper('pagarmev5_core');
	...
	private function paymentMethodUsedWasPagarme(
		...
		return $quote->getPayment()->getMethod() == 'pagarmev5_creditcard';
	}
